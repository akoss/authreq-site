      ...
      <div class="card">
        <div class="card-body">
          ...
          <?php else: ?>
            ...
            <button type="submit" class="btn btn-lg btn-success float-right" name="sign" value="1"><i class="mdi mdi-lock text-white"></i>Sign</button>
            <h5 style="margin-top: 13px; margin-right: 15px;" class="float-right">Please sure that everything is correct before proceeding.</h5>
          <?php endif; ?>
        </div>
      </div>
    </div>
